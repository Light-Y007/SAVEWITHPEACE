...
var connection = mysql.createConnection({
  host     : 'database-1.c8t5jm68t8my.ap-south-1.rds.amazonaws.com',
  password : 'Root1234',
  database : 'database-1',//'userdata',
  port : '3306',
  timeout: 60000
});
try {
...
app.post('/api/usercheck',upload.any(),function(req,res){
 ...
 app.post('/api/userdata',upload.any(),function (req,res) {
    ...
    ///console.log(req.body.emailid);
        ...
        var emailid = req.body.emailid, filelocation = 'https://d1b72khdqu20ob.cloudfront.net'+req.files[0].key, filekey= req.files[0].key,filename=req.files[0].originalname, created= Date.now();//req.files[0].location; 
